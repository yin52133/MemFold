---
name: memfold-memory
description: Use as the top-level router for Claude Code memory workflows backed by MemFold. Trigger when the task involves startup memory, retrieving prior work, remembering stable constraints, rejecting wrong memory, or consolidating memory.
---
